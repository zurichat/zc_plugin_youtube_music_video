...
export const { changedPlaying, showedPlayer, changedCurrentSong } =	slice.actions;

export const getPlayerState = (state: RootState) => state.player;

export const selectCurrentSong = (state: RootState) => state.songs.find((s) => s.id === state.player.currentSongId);
