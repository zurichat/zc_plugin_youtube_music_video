			...
			<main className="main__wrapper content_wrapper">
				<section className="grid__one">
					<div className="plugin__dets">
						...
						<button className="btn__large">Add to Zuri</button>
					</div>

					<aside className="side__bar">
						<div className="side__txts">
							<h3 className="mb_bottom">Supported Language</h3>
							<p className="margin">English</p>
						</div>

						<div className="side__txts">
							<h3 className="mb_bottom">Pricing</h3>
							<p className="margin">N10,000 (7 days free trial)</p>
						</div>
						...
						<div className="side__txts">
							<h3 className="mb_bottom">Category</h3>
							<div className="btns margin">
								<a href="#">
									<button className="btn__small">Music</button>
								</a>
								<a href="#">
									<button className="btn__small">Playlist</button>
								</a>
							</div>
						</div>
					</aside>
				...
				<section className="grid-two">
					...
					<div className="tabs">
						<ul className="tab-header">
							<li data-tab-target="#description" className="active tab">
								Description
							</li>
							<li data-tab-target="#review" className="tab">
								Review
							</li>
							<li data-tab-target="#faq" className="tab">
								FAQ
							</li>
						</ul>
						...
						<div className="tab-body">
							...
							<div id="description" data-tab-content className="active">
								...
								<div className="display__txt">
									<p>
										The Zuri Youtube plugin lets you share youtube videos and
										audio with your team. Once installed, you can share youtube
										links that can be played on the platform without being
										redirected to youtube. You can also create songs playlists
										and also add songs to the general music library where other
							...
							<div id="review" data-tab-content>
								<div className="review__bx">
									...
									<div className="review__txts">
										<h3 className="small">This is awesome!!!</h3>

										<p className="large">
											This is exactly what i was looking for, I love the feature
											where i could play videos on the platform without getting
							...
							<div id="faq" data-tab-content>
								<div className="faq__bx">
									...
									<p>
										...
										<br />
										A: No, the plugin can be installed by any member of the
										organization.
									</p>
