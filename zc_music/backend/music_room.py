...
@app.post("/api/v1/org/{org_id}/rooms/{room_id}", status_code = status.HTTP_200_OK, response_model=schema.Music,
responses={404: {"model": schema.MessageError}, 
            424: {"model": schema.MessageError}, 302: {"model": schema.MessageError}})
async def add_member_to_room(org_id: str, room_id: str, room: schema.Music, ):
...
#                                "plugin_id": settings.PLUGIN_ID,
                        ...
                        if (
                            ...
                            return JSONResponse(
                                content={"message":"User/users added but centrifugo not available"},
